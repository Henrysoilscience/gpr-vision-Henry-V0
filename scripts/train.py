...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "using a shared path improves reproducibility."
        ),
    )
    parser.add_argument(
        ...
        default=None,
        help=(
            "Optional checkpoint filename/path to initialize from; "
            "relative values are resolved against --model-dir."
        ),
    )
...
def main() -> None:
    ...
    with mlflow.start_run(run_name=args.mlflow_run_name):
        ...
        summary = {
            ...
            "model_dir": str(config.model_dir),
            "pretrained_checkpoint": (
                str(config.pretrained_checkpoint)
                if config.pretrained_checkpoint is not None
                else None
            ),
